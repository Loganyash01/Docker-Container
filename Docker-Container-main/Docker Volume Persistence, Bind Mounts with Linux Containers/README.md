...
- Since `/data` is a bind-mounted directory, the file was actually stored in `C:\Users\Ryuk\docker_data` on the host.
...
- The same bind-mounted directory (`C:\Users\Ryuk\docker_data`) was mounted to `/data`.
