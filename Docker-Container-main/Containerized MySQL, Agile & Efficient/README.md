...
- ✅ Create an SQL initialization script (e.g., `Yash_demo.sql`) with database and table definitions.
...
COPY Yash_demo.sql /docker-entrypoint-initdb.d/
...
Create a file named `Yash_demo.sql` in the same directory:
